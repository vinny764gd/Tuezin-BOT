...
exports.run = (bot, msg, args) => {
    ...
    if (!args[0]) {
        ...
        embed.setDescription(`Olá, sou **${bot.user.username}** estou feliz para poder participar do seu servidor! Me adicione [aqui](https://discord.com/api/oauth2/authorize?client_id=902627366453510214&permissions=8&scope=bot) ficarei muito grata! ❤️\n\n<:aviso:686628220333981700> Temos no total de \`${bot.commands.size}\` comandos para você explorar!`)
        ...
        embed.addField(`Você gosta das minhas funções?`, `Clique [aqui](https://discord.com/api/oauth2/authorize?client_id=902627366453510214&permissions=8&scope=bot) para me adicionar no seu servidor.`)
        embed.setColor(`#6800e5`)
        embed.setFooter(`Versão atual: 1.1.3`)
